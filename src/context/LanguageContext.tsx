...
export const TRANSLATIONS: Record<LanguageCode, Record<TranslationKey, string>> = {
  en: {
    ...
    heroSubtitle: 'Challenge specific handles directly or post open bounties for the wider public. Submit photo or video proof, get evaluated by our fun AI judge, and earn Cred.',
    ...
    tabBounties: 'Open Bounties',
    tabReview: 'Proof Gallery',
    tabVerified: 'Verified Hall',

    filterAll: 'All Dares',
    filterPublic: 'Public Bounties',
